...
public abstract class AppBarMainBinding extends ViewDataBinding {
  ...
  @NonNull
  public final Toolbar toolbarMainDrawer;

  protected AppBarMainBinding(Object _bindingComponent, View _root, int _localFieldCount,
      AppBarLayout appbar, CoordinatorLayout coordinator, Toolbar toolbarMainDrawer) {
    super(_bindingComponent, _root, _localFieldCount);
    this.appbar = appbar;
    this.coordinator = coordinator;
    this.toolbarMainDrawer = toolbarMainDrawer;
  }
