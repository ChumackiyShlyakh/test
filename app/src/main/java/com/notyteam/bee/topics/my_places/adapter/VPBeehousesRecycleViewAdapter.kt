...
class VPBeehousesRecycleViewAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.imgbtn_cardview_vp_beehouses_controls.setOnClickListener({ v ->
...
//            dialog.setCancelable(false)
    ...
    class ViewHolder(itemView: View?) : RecyclerView.ViewHolder(itemView!!) {
        ...
        var imgbtn_cardview_vp_beehouses_controls: ImageButton =
            itemView!!.findViewById(R.id.imgbtn_cardview_vp_beehouses_controls)
    }
}