...
class VPArchiveRecycleViewAdapter(
    private var context: Context,
    private var dataList: ArrayList<String>
) :
    RecyclerView.Adapter<VPArchiveRecycleViewAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.imgbtn_cardview_vp_archive_controls.setOnClickListener({ v ->
    ...
    class ViewHolder(itemView: View?) : RecyclerView.ViewHolder(itemView!!) {
        ...
        var imgbtn_cardview_vp_archive_controls: ImageButton =
            itemView!!.findViewById(R.id.imgbtn_cardview_vp_archive_controls)
//        iv_cardview_vp_archive_object
//        tv_cardview_vp_archive_name
//        iv_cardview_vp_archive_maps_flags
//        tv_cardview_vp_object_text
//        tv_cardview_vp_object_status
//        tv_cardview_vp_archive_latitude_numbers
//        tv_cardview_vp_archive_longitude_numbers
//        tv_cardview_vp_archive_data_start
//        tv_cardview_vp_archive_data_end
//        tv_cardview_vp_archive_user_id
    }
}